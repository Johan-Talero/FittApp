package com.fitness.fittapp.UI.Home.Saturday
...
class SaturdayActivity : AppCompatActivity() {
    ...
    private lateinit var binding: ActivitySaturdayBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivitySaturdayBinding.inflate(layoutInflater)
        setContentView(binding.root)
        binding.imageURL.setOnClickListener {
            val youtubeVideoVaccine = "https://www.youtube.com/watch?v=hT0b6IvqQ5g"
